...
import org.neutron.device.impl.FontManagerImpl;
...
public class J2SEFontManager implements FontManagerImpl
{
	...
	org.neutron.device.impl.Font getFont(Font meFont)
	{
    	int key = 0;
    	key |= meFont.getFace();
    	key |= meFont.getStyle();
    	...
    	org.neutron.device.impl.Font result = (org.neutron.device.impl.Font) fonts.get(new Integer(key));
	...
	public void setFont(String face, String style, String size, org.neutron.device.impl.Font font) {
		int key = 0;
	...
	public org.neutron.device.impl.Font createSystemFont(String defName, String defStyle, int defSize, boolean antialiasing) {
		return new J2SESystemFont(defName, defStyle, defSize, antialiasing);
	}

	public org.neutron.device.impl.Font createTrueTypeFont(URL defUrl, String defStyle, int defSize, boolean antialiasing) {
