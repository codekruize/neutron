 ...
 * 
 * This class is used instead injected one when application is running in Applet with Neutron.
 *
...
public final class Injected implements Serializable {
	...
	/**
	 * This allow redirection of stdout to Neutron console
	 */
	...
	/**
	 * Redirect throwable.printStackTrace() to Neutron console
	 */
	...
	/**
	 * This code Ingected By Neutron to enable access to System properties while running in Applet
     *
