...
import org.neutron.app.classloader.ExtensionsClassLoader;
import org.neutron.app.classloader.MIDletClassLoader;
import org.neutron.app.classloader.MIDletClassLoaderConfig;
...
import org.neutron.app.util.MIDletThread;
import org.neutron.app.util.MIDletTimer;
import org.neutron.app.util.MIDletTimerTask;
...
import org.neutron.log.StdOutAppender;
import org.neutron.microedition.ImplFactory;
import org.neutron.microedition.ImplementationInitialization;
import org.neutron.microedition.io.ConnectorImpl;
import org.neutron.util.Base64Coder;
import org.neutron.util.JadMidletEntry;
import org.neutron.util.JadProperties;
import org.neutron.util.MemoryRecordStoreManager;

public class Common implements Neutron, CommonInterface {
    ...
    protected String saveJar2TmpFile(String jarUrl, boolean reportError) {
        ...
        try {
            ...
            if (systemTmpDir != null) {
                tmpDir = new File(systemTmpDir, "Neutron-apps-" + MIDletSystemProperties.getSystemProperty("user.name"));
    ...
    private MIDlet loadMidlet(Class midletClass, MIDletAccess previousMidletAccess) {
        ...
        MIDletBridge.getRecordStoreManager().init(MIDletBridge.getNeutron());
        try {
            MIDlet m;
    ...
    private MIDletClassLoader createMIDletClassLoader(boolean forJad) {
        ...
        if (!Serializable.class.isAssignableFrom(Injected.class)) {
            Logger.error("classpath configuration error, Wrong Injected class detected. neutron-injected module should be after neutron-javase in eclipse");
        }
