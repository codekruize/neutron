...
import org.neutron.device.InputMethodEvent;
import org.neutron.device.InputMethodListener;
...
public class TextBox extends Screen {
	...
	public void delete(int offset, int length) {
		if (ui != null && ui.getClass().getName().equals("org.neutron.android.device.ui.AndroidTextBoxUI")) {
